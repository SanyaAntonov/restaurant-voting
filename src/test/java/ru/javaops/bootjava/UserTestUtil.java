...
public class UserTestUtil {
    ...
    public static final User user = new User(USER_ID, USER_MAIL, "Ivan", "Ivanov", "password", List.of(Role.USER));
    public static final User admin = new User(ADMIN_ID, ADMIN_MAIL, "Vladimir", "Putin", "admin", List.of(Role.ADMIN, Role.USER));
